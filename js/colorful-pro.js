class ColorfulProApp {
    ...
    drawHorizontalPalette(canvas, ctx) {
        ...
        ctx.textAlign = 'center';
        ctx.fillText('Color Palette by カラフラ', width / 2, 50);
    ...
    drawGridPalette(canvas, ctx) {
        ...
        ctx.textAlign = 'center';
        ctx.fillText('Color Palette by カラフラ', canvas.width / 2, 40);
    ...
    drawCirclePalette(canvas, ctx) {
        ...
        ctx.textAlign = 'center';
        ctx.fillText('カラフラ', centerX, centerY - 10);
        ctx.font = '16px "Inter", Arial, sans-serif';
    ...
    drawArtistPalette(canvas, ctx) {
        ...
        ctx.font = '14px "Inter", Arial, sans-serif';
        ctx.textAlign = 'center';
        ctx.fillText(`Generated by カラフラ - ${new Date().toLocaleDateString('ja-JP')}`, width / 2, height - 30);
    }
    ...
    sharepalette() {
        ...
        const shareText = `カラフラで生成したカラーパレット: ${colors}`;
